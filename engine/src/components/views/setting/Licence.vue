    ...
    <div class="content_box">
      ...
      <div class="licence_table">
        <el-table ref="multipleTable"
          ...
          <el-table-column label='许可证版本'
                           align="center"
                           show-overflow-tooltip>
            <template slot-scope="scope"
                      show-overflow-tooltip>
              <span v-if="!scope.row.use_edition"></span>
              <span v-if="scope.row.use_edition&&scope.row.use_edition==1">测试版</span>
              <span v-if="scope.row.use_edition&&scope.row.use_edition==2">正式版</span>
            </template>
          </el-table-column>
